...
Desktopr Bridge API exposes version of the [File System](https://desktopr.app/guide/bridge/api/file-system.md) module scoped to a specific plugin storage.
...
Using this Desktopr plugin template repo:
...
1. Download this plugin template repo:

   [CLICK HERE TO DOWNLOAD](https://github.com/Desktopr/dtr-plugin-template/archive/refs/heads/main.zip)
...
```ts
await Desktopr.plugins.modules.addFromBytes("my-plugin.wasm", wasmBytes);
```
