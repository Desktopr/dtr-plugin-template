...
/* ============================
   WARNING: TEMPLATE RUNTIME FILE
   - This file is part of the Desktopr plugin runtime template.
   - Do not edit this file unless you know exactly what you are changing.
   - User functions should be added in the dedicated functions file.
   - Editing this file may break stdin/stdout handling, JSON response formatting,
     error handling, or compatibility with Desktopr's plugin runtime.
   ============================ */
...
fn main() {
    let _ = std::io::stderr().write_all(b"entered _start\n");
...
/* ============================
    ...
    - This file is part of the Desktopr plugin runtime template.
    - Do not edit this file unless you know exactly what you are changing.
    - User functions should be added in the dedicated functions file/module.
    - Editing this file may break stdin/stdout handling, JSON response formatting,
      error handling, or compatibility with Desktopr's plugin runtime.
============================ */